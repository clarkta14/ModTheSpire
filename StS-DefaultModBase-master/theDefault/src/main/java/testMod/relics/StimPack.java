...
public class StimPack extends CustomRelic implements ClickableRelic { // You must implement things you want to use from StSlib
    /*
    ...
    // ID, images, text.
    public static final String ID = DefaultMod.makeID(StimPack.class.getSimpleName());
