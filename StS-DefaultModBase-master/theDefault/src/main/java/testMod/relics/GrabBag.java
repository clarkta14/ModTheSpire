...
public class GrabBag extends CustomRelic implements ClickableRelic { // You must implement things you want to use from StSlib
    /*
    ...
    // ID, images, text.
    public static final String ID = DefaultMod.makeID(GrabBag.class.getSimpleName());
...
//            AbstractDungeon.actionManager.addToBottom(new EvokeOrbAction(1)); // Evoke your rightmost orb
            ...
            AbstractDungeon.actionManager.addToBottom(new ObtainPotionAction(new BottledLightning()));
        }
    }
