...
public class BottledMiracleUpgradable extends BottledMiracle implements UpgradablePotion {
    public static final String POTION_ID = testMod.DefaultMod.makeID(BottledMiracleUpgradable.class.getSimpleName());

    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    private static final PotionStrings oldPotionStrings = CardCrawlGame.languagePack.getPotionString("BottledMiracle");
    ...
    public BottledMiracleUpgradable() {
        super();
        initializeData();
    }
    ...
    public int getPotency(final int ascension) {
        return 2 + (int) Math.floor(potionLevel  / maxPotionLevel);
    }
