...
public class BloodPotionUpgradable extends BloodPotion implements UpgradablePotion {
    public static final String POTION_ID = testMod.DefaultMod.makeID(BloodPotionUpgradable.class.getSimpleName());

    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    private static final PotionStrings oldPotionStrings = CardCrawlGame.languagePack.getPotionString("BloodPotion");

    public static final String NAME = oldPotionStrings.NAME;
    public static final String[] DESCRIPTIONS = potionStrings.DESCRIPTIONS;

    private int potionLevel = 0;
    private static int maxPotionLevel = 30;

    public BloodPotionUpgradable() {
        super();
        initializeData();
    }
    ...
    public int getPotency(final int ascension) {
        return 20 + (int) Math.floor(potionLevel  / 3);
    }
