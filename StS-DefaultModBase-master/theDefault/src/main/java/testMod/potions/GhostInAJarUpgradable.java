...
public class GhostInAJarUpgradable extends GhostInAJar implements UpgradablePotion {
    public static final String POTION_ID = testMod.DefaultMod.makeID(GhostInAJarUpgradable.class.getSimpleName());

    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    private static final PotionStrings oldPotionStrings = CardCrawlGame.languagePack.getPotionString(GhostInAJar.POTION_ID);
