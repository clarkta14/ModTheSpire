...
public class DistilledChaosPotionUpgradable extends DistilledChaosPotion implements UpgradablePotion{
    public static final String POTION_ID = testMod.DefaultMod.makeID(DistilledChaosPotionUpgradable.class.getSimpleName());

    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    private static final PotionStrings oldPotionStrings = CardCrawlGame.languagePack.getPotionString("DistilledChaos");
    ...
    public DistilledChaosPotionUpgradable() {
        super();
        initializeData();
    }
