...
public class ExplosivePotionUpgradable extends ExplosivePotion implements UpgradablePotion {
    public static final String POTION_ID = testMod.DefaultMod.makeID(ExplosivePotionUpgradable.class.getSimpleName());

    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    private static final PotionStrings oldPotionStrings = CardCrawlGame.languagePack.getPotionString(ExplosivePotion.POTION_ID);
    ...
    public ExplosivePotionUpgradable() {
        super();
        initializeData();
    }
