...
public class WeakenPotionUpgradable extends WeakenPotion implements UpgradablePotion {
    public static final String POTION_ID = testMod.DefaultMod.makeID(WeakenPotionUpgradable.class.getSimpleName());

    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    private static final PotionStrings oldPotionStrings = CardCrawlGame.languagePack.getPotionString(WeakenPotion.POTION_ID);
    ...
    //TODO: maybe instead of just 15 potency it affects all enemies. Same for FearPotion.
