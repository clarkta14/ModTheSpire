...
public class FruitJuiceUpgradable extends FruitJuice implements UpgradablePotion {
    public static final String POTION_ID = testMod.DefaultMod.makeID(FruitJuiceUpgradable.class.getSimpleName());

    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    private static final PotionStrings oldPotionStrings = CardCrawlGame.languagePack.getPotionString(FruitJuice.POTION_ID);
