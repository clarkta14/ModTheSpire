...
public class ColorlessPotionUpgradable extends ColorlessPotion implements UpgradablePotion {
    public static final String POTION_ID = testMod.DefaultMod.makeID(ColorlessPotionUpgradable.class.getSimpleName());

    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    private static final PotionStrings oldPotionStrings = CardCrawlGame.languagePack.getPotionString("ColorlessPotion");
    ...
    public ColorlessPotionUpgradable() {
        super();
        initializeData();
    }
    ...
    public void use(AbstractCreature target) {
        if (getPotionLevel() >= maxPotionLevel) {
            this.addToBot(new DiscoveryActionUpgradedOptions(true, this.potency));
        } else {
            super.use(target);
        }
    }
