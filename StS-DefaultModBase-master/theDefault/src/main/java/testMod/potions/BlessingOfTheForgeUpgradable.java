...
public class BlessingOfTheForgeUpgradable extends BlessingOfTheForge implements UpgradablePotion {
    ...
    private static final PotionStrings oldPotionStrings = CardCrawlGame.languagePack.getPotionString("BlessingOfTheForge");
    ...
    public BlessingOfTheForgeUpgradable() {
        super();
        initializeData();
    }

    public BlessingOfTheForgeUpgradable(int potionLevel) {
        super();
