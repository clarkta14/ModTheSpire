...
public class CunningPotionUpgradable extends CunningPotion implements UpgradablePotion {
    public static final String POTION_ID = testMod.DefaultMod.makeID(CunningPotionUpgradable.class.getSimpleName());

    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    private static final PotionStrings oldPotionStrings = CardCrawlGame.languagePack.getPotionString("CunningPotion");
    ...
    public CunningPotionUpgradable() {
        super();
        initializeData();
    }
    ...
    public int getPotency(final int ascension) {
        return 3 + (2 * (int) Math.floor(potionLevel  / maxPotionLevel));
    }
