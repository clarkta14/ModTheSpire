...
public class EssenceOfSteelUpgradable extends EssenceOfSteel implements UpgradablePotion {
    public static final String POTION_ID = testMod.DefaultMod.makeID(EssenceOfSteelUpgradable.class.getSimpleName());

    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    private static final PotionStrings oldPotionStrings = CardCrawlGame.languagePack.getPotionString(EssenceOfSteel.POTION_ID);

    public static final String NAME = oldPotionStrings.NAME;
    public static final String[] DESCRIPTIONS = potionStrings.DESCRIPTIONS;

    private int potionLevel = 0;
    private static int maxPotionLevel = 12;

    public EssenceOfSteelUpgradable() {
        super();
        initializeData();
    }
    ...
    public int getPotency(int ascensionLevel) {
        return 4 + (int) Math.floor(getPotionLevel() / 2);
    }
