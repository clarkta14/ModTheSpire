...
public class StrengthPotionUpgradable extends StrengthPotion implements UpgradablePotion {
    public static final String POTION_ID = testMod.DefaultMod.makeID(StrengthPotionUpgradable.class.getSimpleName());

    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    private static final PotionStrings oldPotionStrings = CardCrawlGame.languagePack.getPotionString(StrengthPotion.POTION_ID);
    ...
    public StrengthPotionUpgradable() {
        super();
        initializeData();
    }
    ...
    public int getPotency(int ascensionLevel) {
        return 2 + (int) Math.floor(getPotionLevel() / 5);
    }
