...
public class FocusPotionUpgradable extends FocusPotion implements UpgradablePotion {
    ...
    private static final PotionStrings oldPotionStrings = CardCrawlGame.languagePack.getPotionString(FocusPotion.POTION_ID);
    ...
    public void use(AbstractCreature target) {
        ...
        if (getPotionLevel() >= maxPotionLevel) {
            AbstractDungeon.actionManager.addToBottom(
                    new ApplyPowerAction(p, p, new FocusPotionMaxPower(p, p, 1)));
        }
    }
