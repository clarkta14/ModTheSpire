...
public class EnergyPotionUpgradable extends EnergyPotion implements UpgradablePotion {
    public static final String POTION_ID = testMod.DefaultMod.makeID(EnergyPotionUpgradable.class.getSimpleName());

    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    private static final PotionStrings oldPotionStrings = CardCrawlGame.languagePack.getPotionString("Energy Potion");
    ...
    public void use (AbstractCreature target) {
        ...
        if(getPotionLevel() >= maxPotionLevel) {
            ...
            AbstractDungeon.actionManager.addToBottom(
                    new ApplyPowerAction(p, p, new EnergizedPower(p, getPotency())));
        }
    }
